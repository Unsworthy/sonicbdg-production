import { Video, Play, Monitor, Radio, ExternalLink } from 'lucide-react'
...
const VideoCard = ({ video }) => {
  ...
  return (
    <a 
      ...
      className="group relative bg-[#0A0A0A] border border-white/10 overflow-hidden cursor-pointer transition-all duration-300 hover:border-[#FFD700]/50 block"
    >
      ...
      <div className="p-5 border-t border-white/5 relative bg-[#0A0A0A] z-10">
        <div className="flex items-center justify-between mb-2">
           ...
           <ExternalLink className="w-3 h-3 text-white/20 group-hover:text-[#FFD700] transition-colors" />
        </div>
...
<style >{`
  ...
  .animate-marquee {
    ...
    white-space: nowrap;
    /* Ubah ke 60s biar lebih kalem, Zal */
    animation: marquee 60s linear infinite; 
    padding-right: 150px; /* Kasih jeda jauh biar gak numpuk pas muter lagi */
  }
